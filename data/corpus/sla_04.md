...
## Overview
This document describes the sla used by service cluster 4.

## Policy
The availability target is 99.9 percent.
Related configuration keys are namespaced under `sla.v4`.

## Operations
Operators should verify the sla after each change window.
